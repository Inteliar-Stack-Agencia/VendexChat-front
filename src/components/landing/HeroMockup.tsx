...
const HeroMockup = () => {
  return (
    <div className="relative w-64 sm:w-72">
      {/* Side buttons */}
      <div className="absolute left-[-5px] top-28 w-[5px] h-10 bg-slate-700 rounded-l-sm" />
      <div className="absolute left-[-5px] top-44 w-[5px] h-8 bg-slate-700 rounded-l-sm" />
      <div className="absolute right-[-5px] top-36 w-[5px] h-12 bg-slate-700 rounded-r-sm" />
      ...
      <div className="bg-slate-900 rounded-[3rem] p-[10px] shadow-2xl border-[3px] border-slate-700 ring-1 ring-slate-600/30">
        ...
        {/* Screen */}
        <div className="bg-slate-100 rounded-[2.5rem] overflow-hidden flex flex-col" style={{ height: "580px" }}>

          {/* Status bar */}
          <div className="bg-white px-5 pt-7 pb-1.5 flex justify-between items-center">
          ...
          {/* Store header */}
          <div className="bg-emerald-500 px-4 py-3 flex items-center justify-between shadow-md">
          ...
          {/* Products */}
          <div className="flex-1 overflow-hidden px-3 py-2.5 space-y-2 bg-slate-50">
            <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider">Más pedidos hoy</p>

            {products.map((product) => (
              <div
                key={product.name}
                className="bg-white rounded-2xl p-2.5 flex items-center gap-2.5 shadow-sm border border-slate-100"
              >
      ...
      <div className="absolute -right-6 top-20 bg-white rounded-2xl px-3 py-2 shadow-xl border border-slate-100 animate-float">
        <div className="flex items-center gap-1.5">
      ...
      <div
        className="absolute -left-6 bottom-28 bg-emerald-500 rounded-2xl px-3 py-2 shadow-xl animate-float"
      ...
      <div
        className="absolute -right-4 bottom-16 bg-violet-600 rounded-2xl px-3 py-2 shadow-xl animate-float"
