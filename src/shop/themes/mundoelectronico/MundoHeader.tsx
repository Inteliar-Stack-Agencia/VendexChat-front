    ...
    const slides: Slide[] = [
        {
            id: 1,
            type: 'image',
            imageUrl: 'https://images.vendexchat.app/mundoelectronico/hero.webp',
        ...
        },
        {
            ...
            tag: 'Notebooks & PCs',
            title: 'Reparamos y<br/>optimizamos tu PC.',
            subtitle: 'SSD, RAM, limpieza, formateo y más. Resultados en el día.',
            chips: ['Instalación SSD', 'Ampliación RAM', 'Pasta térmica', 'Formateo'],
            icon: <Laptop className="w-28 h-28" style={{ color: `${BLUE}CC` }} />,
        ...
        },
        {
            id: 3,
            type: 'design',
            bg: `linear-gradient(135deg, #0e7490 0%, #0369a1 100%)`,
            tag: 'Tienda online',
            title: 'Accesorios y<br/>electrónica premium.',
            subtitle: 'Auriculares, cargadores, fundas, teclados y más. Con garantía.',
            chips: ['Envío a todo el país', 'Garantía 60 días', 'Productos originales'],
            icon: <ShoppingBag className="w-28 h-28" style={{ color: 'rgba(255,255,255,0.6)' }} />,
            cta: 'Ver tienda',
            accent: '#06B6D4',
        },
        {
            ...
            tag: 'Servicios extra',
            title: 'Más servicios<br/>en nuestro local.',
            subtitle: 'Punto de retiro Pickit · Correo Argentino · Devolución de modems y notebooks.',
            chips: ['Pickit', 'Correo Argentino', 'Dev. modems', 'Dev. notebooks'],
            icon: <Package className="w-28 h-28" style={{ color: `${BLUE}CC` }} />,
            cta: 'Cómo llegar',
            accent: '#6366F1',
        },
        {
            ...
            title: 'Soluciones digitales<br/>con <span style="color:#00A8FF">Inteliar.</span>',
            subtitle: 'Páginas web, ecommerce, sistemas a medida y apps. Transformamos tu negocio.',
            chips: ['Sitios web', 'Ecommerce', 'Apps', 'Software a medida'],
            icon: <Code2 className="w-28 h-28" style={{ color: '#818cf8' }} />,
            cta: 'Conocer Inteliar',
            ctaHref: 'https://inteliar.com',
            accent: '#6366F1',
        },
    ];
