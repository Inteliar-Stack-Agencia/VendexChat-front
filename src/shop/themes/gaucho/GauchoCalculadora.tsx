...
export function GauchoCalculadora({ whatsapp }: { whatsapp?: string }) {
    ...
    return (
        <section id="calculadora" style={{ backgroundColor: C_BEIGE2, padding: 'clamp(48px,6vw,96px) 24px', fontFamily: 'inherit' }}>
            <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 48 }}>
                    ...
                    <h2 style={{ color: C_GREEN, fontSize: 'clamp(2rem,5vw,3.2rem)', fontWeight: 800, margin: '0 0 6px', lineHeight: 1.1 }}>
                        Guía de porciones
                    </h2>
                    <p style={{ color: C_BROWN, fontStyle: 'italic', fontSize: 'clamp(1rem,2vw,1.3rem)', margin: '0 0 14px' }}>
                        calculá la porción ideal ♥
                    </p>
                    <p style={{ color: C_BROWN, opacity: 0.65, fontSize: 15, maxWidth: 460, margin: '0 auto', lineHeight: 1.6 }}>
                ...
                <div style={{
                    ...
                    <div style={{ flex: '1 1 460px', minWidth: 0 }}>
                        ...
                        {/* Pet tabs */}
                        <div style={{ display: 'flex', borderRadius: 14, overflow: 'hidden', border: `1.5px solid ${C_BEIGE}`, marginBottom: 32 }}>
                        ...
                        <div style={{ marginBottom: 28 }}>
                            <p style={{ color: C_BROWN, fontWeight: 700, fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 12 }}>
                                ETAPA DE VIDA
                            </p>
                        ...
                        {/* Result */}
                        <div style={{ backgroundColor: C_BEIGE2, borderRadius: 18, padding: '20px 24px', marginBottom: 20 }}>
                            <p style={{ color: C_GREEN, fontWeight: 700, fontSize: 11, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16 }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 }}>
                                {[
                                    ...
                                    <div key={r.label} style={{
                                        ...
                                        padding: 'clamp(12px,2vw,18px) 12px',
                                        textAlign: 'center',
                                        boxShadow: '0 2px 12px rgba(35,75,52,0.07)',
                                    }}>
                                        <div style={{ fontSize: 20, marginBottom: 6 }}>{r.icon}</div>
                                        <p style={{ color: C_BROWN, opacity: 0.5, fontSize: 10, fontWeight: 700, letterSpacing: '0.06em', marginBottom: 6 }}>{r.label}</p>
                                        <p style={{ color: C_GREEN, fontWeight: 800, fontSize: 'clamp(1rem,2.2vw,1.4rem)', fontStyle: 'italic', margin: '0 0 4px', lineHeight: 1.1 }}>{r.value}</p>
