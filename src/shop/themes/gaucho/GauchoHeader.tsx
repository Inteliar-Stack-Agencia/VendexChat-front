    ...
    return (
        <>
            <style>{`
                ...
                .gnp-ring   { animation: gnp-spin-slow 18s linear infinite; }
                .gnp-cta-btn:hover { transform: translateY(-3px); box-shadow: 0 14px 36px rgba(233,123,99,0.55) !important; }
                .gnp-cta-btn { transition: transform 0.2s, box-shadow 0.2s; }
            `}</style>

            {/* ─ Hero: fondo verde oscuro ─ */}
            <section className="relative overflow-hidden" style={{ backgroundColor: G_DARK, paddingTop: '56px' }}>

                {/* Blob decorativo grande — parte superior derecha */}
                <div style={{
                    position: 'absolute',
                    top: '-25%', right: '-18%',
                    width: '680px', height: '680px',
                    backgroundColor: G_GREEN,
                    borderRadius: '58% 42% 62% 38% / 52% 60% 40% 48%',
                    opacity: 0.45,
                    pointerEvents: 'none',
                }} />
                {/* Blob coral pequeño — inferior izquierda */}
                <div style={{
                    position: 'absolute',
                    bottom: '18%', left: '-8%',
                    width: '260px', height: '260px',
                    backgroundColor: G_CORAL,
                    borderRadius: '52% 48% 45% 55% / 58% 42% 58% 42%',
                    opacity: 0.13,
                    pointerEvents: 'none',
                }} />
                ...
                <div style={{
                    ...
                    backgroundImage: `radial-gradient(circle, rgba(212,165,116,0.35) 1.5px, transparent 1.5px)`,
                ...
                <div style={{
                    ...
                    <div className="order-2 md:order-1"
                        style={{ display: 'flex', flexDirection: 'column', gap: '1.7rem', paddingBottom: '3rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '13px' }}>
                            ...
                            <div>
                                <p className="gaucho-subtitle" style={{ color: G_GOLDEN, fontWeight: 800, fontSize: '1rem', lineHeight: 1.15 }}>
                                    Gaucho Natural Pet
                                </p>
                                <p className="gaucho-body" style={{ color: `${G_SALMON}BB`, fontSize: '0.65rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '2.5px' }}>
                                    Nutrición Natural
                                </p>
                            </div>
                        </div>
                        ...
                        <h1 className="gaucho-subtitle" style={{
                            ...
                            Comida real,<br />
                            <em style={{ fontStyle: 'italic', color: G_GOLDEN }}>vida real.</em>
                        </h1>

                        <p className="gaucho-body" style={{ fontSize: '1.08rem', color: 'rgba(255,255,255,0.68)', lineHeight: 1.78, fontWeight: 300, maxWidth: '420px' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.9rem', alignItems: 'center' }}>
                            <a href="#productos" className="gaucho-body gnp-cta-btn" style={{
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.65rem' }}>
                            {[['🥩', 'Carne Real'], ['🌿', 'Sin Cereales'], ['✨', 'Sin Aditivos']].map(([icon, label]) => (
                                <span key={label} className="gaucho-body" style={{
                        ...
                        {address && (
                            <p className="gaucho-body" style={{ color: 'rgba(255,255,255,0.42)', fontSize: '0.8rem' }}>📍 {address}</p>
                        )}
                    </div>

                    {/* ── RIGHT: perro en blob beige (multiply elimina el blanco) ── */}
                    <div className="order-1 md:order-2"
                        style={{ position: 'relative', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', minHeight: '540px' }}>

                        {/* Blob beige/crema orgánico — fondo del perro */}
                        <div style={{
                            position: 'absolute',
                            bottom: '0%', left: '50%',
                            ...
                            borderRadius: '58% 42% 52% 48% / 50% 62% 38% 50%',
                            zIndex: 1,
                            boxShadow: `0 30px 80px rgba(0,0,0,0.28)`,
                        }} />

                        {/* Ring dorado giratorio */}
                        <div className="gnp-ring" style={{
                            position: 'absolute',
                            top: '8%', left: '12%',
                        ...
                        <div style={{
                            ...
                            opacity: 0.75,
                            zIndex: 6,
                            boxShadow: `0 4px 12px ${G_CORAL}60`,
                        }} />
                        ...
                        {/* Perro — multiply hace el blanco transparente sobre el blob */}
                        <img
                        ...
                        <div className="gnp-leaf1" style={{
                            ...
                            backgroundColor: '#fff', borderRadius: '18px', padding: '10px 15px',
                ...
                {/* Curva orgánica hacia Benefits (blanco) */}
                <CurveDown from={G_DARK} to="#ffffff" />
            </section>
        </>
    );
}
...
function BenefitsSection() {
    ...
    return (
        <section id="beneficios" className="relative overflow-hidden" style={{ backgroundColor: '#ffffff', paddingTop: '2rem', paddingBottom: '1rem' }}>
            {/* Blob golden decorativo */}
            <div style={{
                position: 'absolute',
                top: '-10%', right: '-8%',
                    ...
                    {items.map((b) => (
                        <div key={b.title}
                            ...
                            onMouseEnter={e => {
                                ...
                                (e.currentTarget as HTMLElement).style.boxShadow = `0 16px 40px ${G_GREEN}22`;
                            }}
                            onMouseLeave={e => {
...
function AboutSection() {
    ...
    return (
        <section id="nosotros" className="relative overflow-hidden" style={{ backgroundColor: G_CREAM, paddingTop: '2rem' }}>
            {/* Blob verde fondo */}
            <div style={{
                position: 'absolute',
                bottom: '-15%', left: '-12%',
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-12 py-20 relative" style={{ zIndex: 10 }}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
                    ...
                    {/* Izquierda: imagen en círculo orgánico */}
                    <div className="relative flex items-center justify-center" style={{ minHeight: '420px' }}>
                        ...
                        <div style={{
                            ...
                            opacity: 0.85,
                            boxShadow: `0 24px 60px ${G_GREEN}30`,
                        }} />
                        {/* Foto */}
                        <div style={{
    ...
    return (
        <header>
            ...
            <div className="sticky top-0 z-50"
                style={{ backgroundColor: 'rgba(26,61,34,0.97)', backdropFilter: 'blur(14px)', boxShadow: '0 4px 30px rgba(0,0,0,0.2)' }}>
                <div className="max-w-7xl mx-auto px-5 py-3.5 flex items-center gap-4">
                    {/* Logo */}
                    <div className="flex items-center gap-2 flex-shrink-0">
                        <div className="w-8 h-8 rounded-full overflow-hidden" style={{ border: `2px solid ${G_GOLDEN}60` }}>
                            <img src={logo || '/gaucho/logo.png.png'} alt={name} className="w-full h-full object-contain p-0.5" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }} />
                        </div>
                    ...
                    <nav className="hidden md:flex items-center gap-6 ml-4">
                        {[['#productos', 'Productos'], ['#beneficios', 'Beneficios'], ['#nosotros', 'Nosotros']].map(([href, label]) => (
                            <a key={href} href={href}
                                className="gaucho-body text-sm font-medium transition-colors"
                    ...
                    <div className="flex items-center gap-1 ml-auto">
                        {whatsapp && !hideChatButton && (
                            <button onClick={onChatClick}
                                ...
                                style={{ backgroundColor: `${G_CORAL}25`, color: G_SALMON }}>
